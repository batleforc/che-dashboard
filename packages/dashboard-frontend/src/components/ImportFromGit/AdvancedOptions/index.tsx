...
export class AdvancedOptions extends React.PureComponent<Props, State> {
  ...
  public render() {
    const { containerImage, temporaryStorage, createNewIfExisting, memoryLimit, cpuLimit } = this.state;
    return (
      <Form isHorizontal={true} onSubmit={e => e.preventDefault()}>
        ...
        />
        <CpuLimitField onChange={cpuLimit => this.handleCpuLimit(cpuLimit)} cpuLimit={cpuLimit} />
      </Form>
    );
  }
}
